...
class GauntletChapters:
    ...
    def edit_all_gauntlets(save_file: core.SaveFile):
        gauntlets = save_file.gauntlets
        gauntlets.edit_chapters_auto(save_file, "A", 24000)
    ...
    def edit_all_collab_gauntlets(save_file: core.SaveFile):
        gauntlets = save_file.collab_gauntlets
        gauntlets.edit_chapters_auto(save_file, "CA", 27000)
    ...
    def edit_all_behemoth_culling(save_file: core.SaveFile):
        gauntlets = save_file.behemoth_culling
        gauntlets.edit_chapters_auto(save_file, "Q", 31000)
    ...
    def edit_chapters_auto(self, save_file: core.SaveFile, letter_code: str, base_index: int):
        edits.map.edit_chapters_auto(save_file, self, letter_code, base_index=base_index)
