    ...
    def get_features(self):
        ...
        features: dict[str, Any] = {
            ...
            "specials": {
                ...
                "event_ticketsα": edits.event_tickets.EventTickets.editα,
                ...
                "all_gauntlet": core.game.map.gauntlets.GauntletChapters.edit_all_gauntlets,
                "all_collab_gauntlet": core.game.map.gauntlets.GauntletChapters.edit_all_collab_gauntlets,
                "all_behemoth_culling": core.game.map.gauntlets.GauntletChapters.edit_all_behemoth_culling,
                "all_towers": core.game.map.tower.TowerChapters.edit_all_towers,
                "all_dojo_catclaw_championships": core.game.map.zero_legends.ZeroLegendsChapters.edit_all_catclaw_championships,
